...
class reporte:
    ...
    def generar_reporte_linea(self,Via_Principal,Via_secundaria,Movimiento,Acceso,Salida,DD,MM,AAAA,periodo):    
        self.leyenda="FECHA,Calle,Carrera,Descripcion,Origen,Destino,Periodo,Peaton,Particular,Taxi,Motociclista,Bus,Camion,Minivan,Ciclista,Tractomula,Scooter,Bicitaxi,\n"
...
folder=easygui.diropenbox(title="Seleccione la carpeta con los reportes de videos a unir",default="/home/francisco/ReportesAforosSDM/")
